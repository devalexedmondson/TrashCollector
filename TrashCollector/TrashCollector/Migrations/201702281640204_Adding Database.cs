namespace TrashCollector.Migrations
{
    ...
    public partial class AddingDatabase : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AddressID_ID = c.Int(),
                        Pick_Up_OptionsID_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Addresses", t => t.AddressID_ID)
                .ForeignKey("dbo.Pick_Up_Options", t => t.Pick_Up_OptionsID_ID)
                .Index(t => t.AddressID_ID)
                .Index(t => t.Pick_Up_OptionsID_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Users", "Pick_Up_OptionsID_ID", "dbo.Pick_Up_Options");
            ...
            DropForeignKey("dbo.Users", "AddressID_ID", "dbo.Addresses");
            ...
            DropIndex("dbo.Users", new[] { "Pick_Up_OptionsID_ID" });
            DropIndex("dbo.Users", new[] { "AddressID_ID" });
